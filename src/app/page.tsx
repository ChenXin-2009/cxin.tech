  ...
  return (
    <main className="min-h-screen relative">
      ...
      <div className="relative z-10 min-h-screen flex items-center justify-end p-8 pointer-events-none">
        <div className="w-full max-w-2xl text-right text-white pointer-events-auto">
          <h1 className="text-5xl font-extrabold mb-4">CXIN.tech</h1>
          ...
          <div className="mt-6 flex justify-end">
            <a href="#" className="inline-block px-4 py-2 border border-white/20 rounded hover:bg-white/5">Learn more</a>
          </div>
        </div>
      </div>
    </main>
